...
async function loadWeather() {
    ...
    try{
        ...
        widget.innerHTML=`<div class="weather-card-inner" style="position:relative;isolation:isolate;display:flex;align-items:center;gap:16px;width:100%;padding:14px 15px;overflow:hidden;border:1px solid rgba(255,255,255,.28);border-radius:20px;background:linear-gradient(135deg,rgba(255,255,255,.18),rgba(125,180,255,.11));box-shadow:inset 0 1px 0 rgba(255,255,255,.28),0 10px 30px rgba(15,30,60,.12);backdrop-filter:blur(7px);"><span aria-hidden="true" style="position:absolute;z-index:-1;right:-24px;top:-38px;width:105px;height:105px;border-radius:50%;background:radial-gradient(circle,rgba(255,205,93,.3),rgba(255,205,93,0) 68%);"></span><span aria-hidden="true" style="position:absolute;z-index:-1;left:35%;bottom:-48px;width:130px;height:90px;border-radius:50%;background:radial-gradient(circle,rgba(88,160,255,.2),rgba(88,160,255,0) 70%);"></span><div class="weather-icon" style="width:64px;height:64px;flex:none;display:grid;place-items:center;border:1px solid rgba(255,255,255,.3);border-radius:20px;background:linear-gradient(145deg,rgba(255,205,93,.38),rgba(96,165,250,.24));box-shadow:inset 0 1px 0 rgba(255,255,255,.42),0 9px 24px rgba(30,70,120,.15);"><i class="fas ${weather[1]}" style="font-size:30px;filter:drop-shadow(0 4px 6px rgba(0,0,0,.2));"></i></div><div class="weather-info" style="min-width:0;flex:1;"><div style="display:flex;align-items:flex-start;justify-content:space-between;gap:8px;"><div class="weather-temp" style="font-size:32px;font-weight:800;line-height:1;letter-spacing:-1.4px;text-shadow:0 2px 8px rgba(0,0,0,.08);">${temp}<span style="font-size:16px;font-weight:650;vertical-align:top;letter-spacing:0;">°C</span></div><div class="weather-city" title="${escapeHtml(pos.city)}" style="max-width:120px;padding:4px 8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;border-radius:999px;background:rgba(255,255,255,.14);font-size:12px;font-weight:600;"><i class="fas fa-map-marker-alt" style="margin-right:4px;color:#fb7185;"></i>${escapeHtml(pos.city)}</div></div><div class="weather-desc" style="margin-top:6px;font-size:14px;font-weight:700;letter-spacing:.5px;">${weather[0]}</div><div style="display:flex;align-items:stretch;gap:8px;margin-top:10px;"><span style="display:flex;align-items:center;gap:5px;min-width:52px;padding:6px 9px;border:1px solid rgba(255,125,100,.18);border-radius:11px;background:linear-gradient(135deg,rgba(255,135,105,.22),rgba(255,190,120,.1));box-shadow:inset 0 1px 0 rgba(255,255,255,.2);font-size:14px;font-weight:750;"><i class="fas fa-arrow-up" style="font-size:10px;color:#fb7185;"></i>${high}°</span><span style="display:flex;align-items:center;gap:5px;min-width:52px;padding:6px 9px;border:1px solid rgba(75,145,255,.18);border-radius:11px;background:linear-gradient(135deg,rgba(80,150,255,.22),rgba(100,210,255,.1));box-shadow:inset 0 1px 0 rgba(255,255,255,.2);font-size:14px;font-weight:750;"><i class="fas fa-arrow-down" style="font-size:10px;color:#60a5fa;"></i>${low}°</span><span style="align-self:center;margin-left:auto;white-space:nowrap;font-size:10px;opacity:.65;"><i class="far fa-clock" style="margin-right:3px;"></i>${updateTime}</span></div></div></div>`;
