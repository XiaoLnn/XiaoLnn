...
async function loadWeather() {
    ...
    try{
        ...
        widget.innerHTML=`<div class="weather-card-inner" style="display:flex;align-items:center;gap:14px;width:100%;padding:4px 2px;"><div class="weather-icon" style="width:58px;height:58px;flex:none;display:grid;place-items:center;border-radius:18px;background:linear-gradient(145deg,rgba(255,200,80,.34),rgba(96,165,250,.22));box-shadow:inset 0 1px 0 rgba(255,255,255,.35),0 8px 24px rgba(0,0,0,.12);"><i class="fas ${weather[1]}" style="font-size:27px;filter:drop-shadow(0 3px 5px rgba(0,0,0,.18));"></i></div><div class="weather-info" style="min-width:0;flex:1;"><div style="display:flex;align-items:flex-start;justify-content:space-between;gap:8px;"><div class="weather-temp" style="font-size:28px;font-weight:750;line-height:1;letter-spacing:-1px;">${temp}<span style="font-size:15px;font-weight:600;vertical-align:top;">°C</span></div><div class="weather-city" title="${escapeHtml(pos.city)}" style="max-width:120px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:12px;opacity:.82;"><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i>${escapeHtml(pos.city)}</div></div><div class="weather-desc" style="margin-top:6px;font-size:14px;font-weight:600;">${weather[0]}</div><div style="display:flex;align-items:center;gap:7px;margin-top:7px;font-size:11px;opacity:.78;"><span style="padding:3px 7px;border-radius:999px;background:rgba(255,120,90,.14);"><i class="fas fa-arrow-up"></i> ${high}°</span><span style="padding:3px 7px;border-radius:999px;background:rgba(80,150,255,.14);"><i class="fas fa-arrow-down"></i> ${low}°</span><span style="margin-left:auto;white-space:nowrap;">${updateTime} 更新</span></div></div></div>`;
